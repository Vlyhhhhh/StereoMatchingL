...
public:
	...
	*/
	bool Initialize(const sint32& width, const sint32& height, const SILCStereoOption& option);
	...
	* \param option		输入，算法参数
	*/
	bool Reset(const uint32& width, const uint32& height, const SILCStereoOption& option);
