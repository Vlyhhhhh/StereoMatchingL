...
#ifndef SILCSTEREO_CROSS_AGGREGATOR_H_
#define SILCSTEREO_CROSS_AGGREGATOR_H_
...
public:
	...
	/** \brief Whether the pixel falls within the superpixel boundary
	*/
	bool IsInSuperPixelBoundary(std::vector<uint8>  slic_image, int width, int x, int y, Mat slic_label) const;
...
private:
	...
	/** \Label map Superpixel segmentation */
	Mat resultLabel;
...
private:
	...
	/** \brief Left image superpixel segmentation array	*/
	vector<uint8> slic_left2;
	/** \brief Right image superpixel segmentation array	*/
	vector<uint8> slic_right2;
